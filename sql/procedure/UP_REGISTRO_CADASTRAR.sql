...
BEGIN
	INSERT INTO imp.REGISTRO (
		...
		, FEE , TIPO_MOEDA_FEE , VALOR_ND_US, VALOR_ND_RS, TAXA_CAMBIO
	)
	SELECT	@IMPORTACAO_ID, @NUMERO_SINISTRO, @CIA , @PROCESSO , @BILHETE , @DATA_EMISSAO_VOUCHER , @REFERENCIA , @DATA_ATENDIMENTO 
			, @DATA_OCORRENCIA , @NOME_SEGURADO , @DOCUMENTO , @VOUCHER , @COBERTURA_RECLAMADA , @NOME_BANCO, @NUMERO_AGENCIA
			, @DIGITO_AGENCIA, @NUMERO_CONTA, @DIGITO_CONTA, @EMAIL_CONTATO, @CUSTO_ORIGINAL , @TIPO_MOEDA 
			, @VALOR_FINAL , @FEE , @TIPO_MOEDA_FEE , @VALOR_ND_US, @VALOR_ND_RS, @TAXA_CAMBIO
END
GO